<template>
  <div className="company" style="  font-size: 0.8rem;padding: 0 0 0.3rem 0.2rem;float: left">세모 헬스장</div>
  <div id="map" style="  width: 23.4rem;height: 5rem"></div>
  <div className="board_list_wrap" style="padding: 1rem">
    <table className="board_list">
      ...
      <tr>
        ...
        <td className="title" style="font-size: 1.3rem;text-align: left">
          <span className="name" style="font-size: 1.3rem"> 김민지 </span><span className="info"
  ...
  <div className="review_list_wrap">
    <table className="review_list" style="border-collapse:separate;border-spacing: 0 0.3rem">
      <caption>후기 목록</caption>
      <tbody>
      <tr>
        <td className="title"
            style="font-size: 1.3rem;text-align: left; width: 18rem; border: 0.1rem solid; padding: 0.7rem; border-radius: 0.3rem">
          <img style="float:right;width: 3.5rem; height: 0.7rem" src="./image/star.png">
          <span><img style="width: 2rem;height: 2rem;" src="./image/user_profile.png"></span><span className="name"
                                                                                                   style="font-size: 1.3rem"> 운동러버 님</span>
          <div className="user_review" style="font-size: 0.8rem">30회 진행할 동안 식단도 꼼꼼히 체크해주시고 운동도 체계적으로 잘 가르쳐 주셨어요 추천합니다.
          </div>
        </td>
      </tr>
      <tr>
